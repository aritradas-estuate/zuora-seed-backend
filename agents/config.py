...
ZUORA_API_RETRY_ATTEMPTS = int(os.getenv("ZUORA_API_RETRY_ATTEMPTS", "3"))
ZUORA_API_RETRY_BACKOFF_FACTOR = float(os.getenv("ZUORA_API_RETRY_BACKOFF_FACTOR", "2.0"))
ZUORA_API_CONNECTION_POOL_SIZE = int(os.getenv("ZUORA_API_CONNECTION_POOL_SIZE", "10"))
ZUORA_API_REQUEST_TIMEOUT = int(os.getenv("ZUORA_API_REQUEST_TIMEOUT", "60"))
ZUORA_OAUTH_TIMEOUT = int(os.getenv("ZUORA_OAUTH_TIMEOUT", "30"))
